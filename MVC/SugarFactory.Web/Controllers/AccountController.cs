...
using SugarFactory.Models.ViewModels.Account;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    IdentityResult roleRes = this.UserManager.AddToRole(user.Id, "SugarUser");
                        
                     if (this._service.UsersCount() == 1)
                    {
                        this.UserManager.AddToRole(user.Id, "Admin");
                    }
                

                    this._service.CreateSugarUser(user);
